...
const ORIGINAL_SUBJECTS: SubjectItem[] = [
...
export const HomeTutoringSlider: React.FC = () => {
  const navigation = useNavigation<NativeStackNavigationProp<RootStackParamList>>();

  const handleSubjectPress = (item: SubjectItem) => {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerRow}>
        ...
        <TouchableOpacity onPress={() => (navigation as any).navigate('Services')}>
