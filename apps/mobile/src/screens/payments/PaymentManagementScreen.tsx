...
const STATUS_FILTERS: Array<'All' | PaymentStatus> = ['All', 'Success', 'Failed', 'Pending'];
...
export const PaymentManagementScreen: React.FC = () => {
  ...
  const handleDownloadInvoice = (txn: TransactionItem) => {
    Alert.alert(
      'Invoice Downloaded',
  ...
  const handleRetryPayment = (txn: TransactionItem) => {
    Alert.alert(
