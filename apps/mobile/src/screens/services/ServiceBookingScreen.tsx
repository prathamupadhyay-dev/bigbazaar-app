...
const SUB_CATEGORIES: Record<string, Array<{ name: string; price: number }>> = {
  Plumber: [
...
export const ServiceBookingScreen: React.FC<Props> = ({ route, navigation }) => {
  ...
  const [paymentChoice, setPaymentChoice] = useState<'Prepaid' | 'Cash on Delivery'>('Prepaid');
