...
function ProviderServiceAds() {
  return (
    <div className="admin-page">
      <div className="admin-header">
        <h2 className="admin-title">Provider Service Ads</h2>
      </div>
      <div className="admin-card">
        <div className="admin-card-header">
          <h3 className="admin-card-title">Manage Provider Service Ads</h3>
        </div>
...
export default ProviderServiceAds;
